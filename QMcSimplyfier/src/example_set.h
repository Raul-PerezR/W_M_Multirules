...
class example_set {
  ...
  public:
    ...
    example_set Extract_Training_Set2(int particion1, int particion2, int VarClase, int order = 0) const;

    example_set Extract_Test_Set(int particion, int VarClase) const;
    example_set Extract_Test_Set2(int particion1, int particion2, int VarClase) const;
