...
class VectorVar {
  ...
  public:
    ...
    int NumberOfContinuousVariable() const;
    ...
    double AdaptacionSinNormalizar(vectordouble x, string regla) const;

    double Adaptacion(vectordouble x, string regla) const;
    double Adaptacion(vectordouble x, string regla, double adaptMin) const;
    double AdaptacionTNormProduct(vectordouble x, string regla, double adaptMin) const;
    double AdaptacionTNormProduct(vectordouble x, string regla, double adaptMin, double peso_regla) const;
    double AdaptacionTNormProductNorm(vectordouble x, string regla, double adaptMin, double peso_regla) const;
