...
public:
  ...
  void Asigna(int n, string varname, int status, int Unit, double c_factor, double inf, double sup, double *a, double *b, double *c, double *d, string *name);
  double Adaptacion(double x) const;
  double Adaptacion(double x, int etiqueta) const;
  double AdaptacionSinNormalizar(double x, string etiqueta) const;
